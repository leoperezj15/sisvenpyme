...
$selectAlmacen = "<select name='compra_add_almacen' id='almacen'  class='form-control'>";
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-9 order-md-1 shadow-lg p-3 mb-5 bg-white rounded">
            <form namespace="add_compra" id="add_compra">
            <h4 class="mb-3">Compra de Productos</h4>
                ...
                <div class="row small">
                    ...
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="number" class="form-control" name="compra_add_nrofactura" id="nro-factura" placeholder="" required>
                        <div class="invalid-feedback">
                            Valid first name is required.
                        </div>
                    </div>
                    <div class="col-md-6 mb-1">
                        ...
                        <input type="date" class="form-control" name="compra_add_fechacompra" id="fecha-compra" placeholder="" required>
                        <div class="invalid-feedback">
                        Valid last name is required.
                        </div>
                    </div>
            ...
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="btnSaveCompra" id="btnSaveCompra">Procesar Compra</button>
            </form>
        </div>
